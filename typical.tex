...
% https://tex.stackexchange.com/questions/77908/hyphenation-of-words-with-accents
...
\setotherlanguages{latin,english}
...
%hack for upright Greek characters in reference (probably pandoc's fault)
% \usepackage[upright]{fourier}
\setmathfont(Digits,Latin,Greek)[]{Gentium}



%left ragged align, uncomment for justified
% \usepackage[document]{ragged2e}

% * * *
\newcommand{\stars}{\bigskip\Large\centerline{* * *}\normalsize}


% \let\Oldrule\rule
% \renewcommand{\rule}{\begin{center}\rule{1in}{0.4pt}\end{center}}
...
%separates citations with commas
\usepackage{fnpct}
...
%todo: add automatic hyperlinks for footnotes
